...
void HelixFitOnGPU::launchBrokenLineKernels(HitsView const *hv,
  ...
  for (uint32_t offset = 0; offset < maxNumberOfTuples; offset += maxNumberOfConcurrentFits_) {
    ...
    kernelBLOne<3><<<numberOfBlocks,blockSize, 0, stream>>>( bField_,
                                                             outputSoa_d,
                                                             tuples_d,
                                                             tupleMultiplicity_d,
                                                             hv,
    ...
    kernelBLOne<4><<<numberOfBlocks ,blockSize, 0, stream>>>( bField_,
                                                             outputSoa_d,
                                                             tuples_d,
                                                             tupleMultiplicity_d,
                                                             hv,
    ...
    if (fit5as4_) {
      ...
      kernelBLOne<5><<<numberOfBlocks,blockSize, 0, stream>>>( bField_,
                                                                   outputSoa_d,
                                                                   tuples_d,
                                                                   tupleMultiplicity_d,
                                                                   hv,
