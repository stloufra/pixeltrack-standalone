...
namespace cufftdx {
    ...
    namespace detail {
        ...
        struct remove_operators<Description, NewOperator> {
            ...
            using type =
                typename CUFFTDX_STD::conditional<can_be_replaced, commondx::detail::filter_t<Description, fft_operator, operator_type>, Description>::type;
        };
        ...
        struct add_operators<Description, OriginalDescription, Force, NewOperator> {
            ...
            using type = typename CUFFTDX_STD::
                conditional<can_be_added, commondx::detail::concatenate_description_t<NewOperator, Description>, Description>::type;
        };
